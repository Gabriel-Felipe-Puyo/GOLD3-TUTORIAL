// DO NOT EDIT THIS FILE! IT IS AUTOMATICALLY GENERATED FROM FILE "src/UniandesEjemplos/FuncsGramTopDown.gold"
package UniandesEjemplos;
import UniandesEjemplos.*;
import gold.*;
...
public final class FuncsGramTopDown {
  static {
  ...
  public static void main(String[] args) {
    ...
    $try:try {
      $line=19;
      GAutomataFrame.show($cast(gold.structures.automaton.IAutomaton.class,FuncsGramTopDown.create()));
    }
    catch (Throwable $throwable) {
      $rethrow($throwable,FuncsGramTopDown.class,"main",$line);
    }
  }
  public static IAutomaton create() {
    ...
    $try:try {
      ...
      $line=36;
      $invokeMethod("push",((gold.structures.automaton.GPushdownAutomaton)M).delta("s","q",$cast(java.lang.String.class,"")),new Object[]{"$E"});
      $line=37;
      ...
      for (Object $v1:GCollections.unmodifiableCollection(\u03A3)) {
        Object t=$v1;
        $line=40;
        $invokeMethod("pop",((gold.structures.automaton.GPushdownAutomaton)M).delta("q","q",$cast(java.lang.String.class,t)),new Object[]{$opAdditY("",t)});
      }
      $line=43;
      ...
      $line=44;
      $invokeMethod("changeTop",((gold.structures.automaton.GPushdownAutomaton)M).delta("q","q",$cast(java.lang.String.class,"")),new Object[]{"E",")L(f"});
      $line=45;
      ...
      $rethrow($throwable,FuncsGramTopDown.class,"create",$line);
    }
  ...
  public static Object testAutomaton(IAutomaton C) {
    ...
    $try:try {
      ...
      $rethrow($throwable,FuncsGramTopDown.class,"testAutomaton",$line);
    }
    return $result;
  }
}
